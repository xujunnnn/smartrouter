 ...
 */
package org.bupt.smartrouter.cli.commands;
...
public class SmartrouterCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(SmartrouterCliTestCommand.class);
    protected final SmartrouterCliCommands service;

    public SmartrouterCliTestCommand(final SmartrouterCliCommands service) {
