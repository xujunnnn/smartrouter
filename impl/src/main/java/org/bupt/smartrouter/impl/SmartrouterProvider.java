...
public class SmartrouterProvider {
    ...
    public SmartrouterProvider(final DataBroker dataBroker,final SalFlowService salFlowService,final NotificationProviderService notificationService,final PacketProcessingService packetProcessingService,SmartRouterConfig config) {
